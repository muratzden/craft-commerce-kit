...
return array(
	...
	'settings'    => array(
		'items' => array( 'type' => 'textarea', 'label' => __( 'Items', 'craft-commerce-kit' ), 'default' => 'Handmade|Honest materials|Small-batch production|Built to age', 'sanitize_callback' => 'sanitize_text_field' ),
	),
);
